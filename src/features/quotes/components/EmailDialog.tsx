...
import { usePostQuotesQuoteEmail } from '@/api/generated/quotes/quotes'
...
export function EmailDialog({ quoteId, open, onOpenChange }: EmailDialogProps) {
  ...
  const sendEmail = usePostQuotesQuoteEmail({
